package com.ynet.imagepicker.adapter;
...
import com.ynet.imagepicker.R;
import com.ynet.imagepicker.bean.ImageItem;
import com.ynet.imagepicker.ui.ImageBaseActivity;
import com.ynet.imagepicker.ui.ImageGridActivity;
import com.ynet.imagepicker.utils.Utils;
import com.ynet.imagepicker.view.SuperCheckBox;
            ...
            holder.cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (holder.cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Toast.makeText(mActivity.getApplicationContext(), "最多选择"+selectLimit+"张图片", Toast.LENGTH_SHORT).show();
